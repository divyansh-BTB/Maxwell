...
export const whyChooseItems = [
  ...
  "Healthcare Hospitality Specialists",
  "Food Safety First Approach",
  "Large-Scale Catering Capability",
...
export const socialChannels = ["Instagram", "Facebook", "LinkedIn", "YouTube"];
