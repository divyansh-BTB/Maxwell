      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {missions.map((mission, index) => (
            <div
              key={mission}
              className="group relative flex min-h-[170px] flex-col justify-between overflow-hidden rounded-2xl border border-[#EAE8E3] bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:border-[#0D2B44] hover:shadow-xl hover:shadow-[#0B1F33]/10"
            >
