      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {channels.map((channel) => (
            <Link
              className="group min-h-[210px] rounded-[1.35rem] border border-[#EAE8E3] bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#0D2B44] hover:bg-[#0D2B44]"
              href={channel.href}
              key={channel.title}
            >
