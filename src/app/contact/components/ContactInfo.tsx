    ...
    <section className="bg-white px-[clamp(20px,5vw,72px)] py-[clamp(72px,9vw,112px)]">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {offices.map((office) => (
            <article
              className="rounded-[1.5rem] border border-[#EAE8E3] bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0D2B44] hover:shadow-xl hover:shadow-[#0B1F33]/10"
              key={office.title}
            >
