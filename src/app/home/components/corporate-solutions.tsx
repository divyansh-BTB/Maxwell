        ...
        <div>
          ...
          <div className="mt-9 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {solutionGroups.map((group) => (
              <article
                className="rounded-[1.25rem] border border-[#EAE8E3] bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:border-[#0D2B44] hover:shadow-xl hover:shadow-[#0B1F33]/8"
                key={group.title}
              >
