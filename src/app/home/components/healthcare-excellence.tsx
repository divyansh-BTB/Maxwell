    ...
    >
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-[clamp(40px,8vw,100px)] lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        ...
        <div className="relative w-full max-w-[500px] mx-auto lg:max-w-none">
          ...
          <div className="group relative aspect-[4/5] w-full overflow-hidden rounded-[2rem] shadow-2xl shadow-[#23443D]/10">
            <Image
            ...
            <div className="absolute inset-0 bg-[#23443D]/10 mix-blend-multiply transition-opacity duration-500 group-hover:opacity-0" />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mb-10 lg:mb-14">
            ...
            <h2 className="mb-6 text-[clamp(2rem,3.5vw,3rem)] font-bold leading-[1.15] text-[#23443D]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-6">
            {stats.map((stat, index) => (
              <div
                className="group relative flex min-h-[140px] cursor-default flex-col justify-end overflow-hidden rounded-2xl border border-[#E5DED1] bg-white p-6 transition-all duration-500 ease-out hover:-translate-y-1 hover:border-[#23443D] hover:bg-[#23443D] hover:shadow-xl hover:shadow-[#23443D]/20"
                key={stat}
              >
                {/* Accent Corner that expands on hover */}
                <div className="absolute -right-6 -top-6 h-16 w-16 rounded-full bg-[#FAFAF8] transition-all duration-500 ease-out group-hover:scale-[15] group-hover:bg-[#1c3631] z-0" />
                ...
                <div className="relative z-10">
                  ...
                  <strong className="block pr-4 text-[1.15rem] leading-[1.3] text-[#23443D] transition-colors duration-500 group-hover:text-white">
                    {stat}
                  </strong>
                </div>
                
                {/* Background Watermark Number - Now visible by default and glows on hover */}
                <span className="absolute bottom-2 right-4 z-0 text-6xl font-black text-[#23443D]/10 transition-colors duration-500 group-hover:text-white/15">
                  0{index + 1}
                </span>
              </div>
            ))}
