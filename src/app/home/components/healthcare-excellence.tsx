        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-6">
            {stats.map((stat, index) => (
              <div
                className="group relative flex min-h-[140px] cursor-default flex-col justify-end overflow-hidden rounded-2xl border border-[#EAE8E3] bg-white p-6 transition-all duration-500 ease-out hover:-translate-y-1 hover:border-[#0B1F33] hover:bg-[#0B1F33] hover:shadow-xl hover:shadow-[#0B1F33]/20"
                key={stat}
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-4 h-1 w-8 rounded-full bg-[#EAE8E3] transition-all duration-500 group-hover:w-12 group-hover:bg-[#0D2B44]" />
